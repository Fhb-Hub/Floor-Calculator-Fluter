...
const kMiddleSpace = 30.0;

const kButtonHeight = 52.0;

const kPrice = 'Preço';
const kPriceWithFooter = 'Preço total com rodapé';
const kPriceWithoutFooter = 'Preço total sem rodapé';
const kArea = 'metro quadrado';
const kClearButton = 'LIMPAR CAMPOS';
